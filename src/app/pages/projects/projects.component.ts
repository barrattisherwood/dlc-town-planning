...
export class ProjectsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  loadFallbackProjects() {
    this.projects.set([
      ...
      {
        id: '21',
        slug: 'portion-27-farm-buffelspoort-373-jq',
        title: 'Subdivision: Portion 27 of the Farm Buffelspoort 373-JQ',
        location: 'Buffelspoort, North West',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Subdivision',
        description: 'Subdivision of Portion 27 of the Farm Buffelspoort 373-JQ into four (4) portions. Situated on the corner of Buffelspoort Road and the R104 between Pretoria and Rustenburg.',
        latitude: -25.6499,
        longitude: 27.9059,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '22',
        slug: 'portion-62-farm-boekenhoutkloof-315-jr',
        title: 'Subdivision: Portion 62 of the Farm Boekenhoutkloof 315-JR',
        location: 'Andeon AH, Pretoria',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Subdivision',
        description: 'Subdivision of Portion 62 of the Farm Boekenhoutkloof 315-JR into two (2) portions. Situated on Kenneth Street, Andeon Agricultural Holdings, Pretoria, 0082.',
        latitude: -25.7220,
        longitude: 28.1150,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '23',
        slug: 'erf-7443-far-east-bank-x9',
        title: 'Subdivision: Erf 7443 Far East Bank Extension 9',
        location: 'Lombardy East, Johannesburg',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Subdivision',
        description: 'Subdivision of Erf 7443 Far East Bank Extension 9 into three (3) portions. Situated on Sheridan Road, Lombardy East, Johannesburg, 2090.',
        latitude: -26.1320,
        longitude: 28.1140,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '24',
        slug: 'erf-190-fulcrum-ekhuruleni',
        title: 'Subdivision: Erf 190 Fulcrum',
        location: 'Fulcrum, Springs',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Subdivision',
        description: 'Subdivision of Erf 190 Fulcrum into two (2) portions. Proposed Portion 1 will be utilised for industrial purposes and the remainder will be utilised as roads. Situated at 10 Radon Road, Fulcrum, Springs, 1559.',
        latitude: -26.2470,
        longitude: 28.4490,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '25',
        slug: 'erf-478-summerset-extension-6',
        title: 'Subdivision: Erf 478 Summerset Extension 6',
        location: 'Carlswald North, Midrand',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Subdivision',
        description: 'Subdivision of Erf 478 Summerset Extension 6 into two (2) portions. Situated at The Boulevard, Carlswald North Lifestyle Estate, Midrand, 1685.',
        latitude: -25.9810,
        longitude: 28.1200,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '26',
        slug: 'erf-298-waterkloof',
        title: 'Subdivision: Erf 298 Waterkloof',
        location: 'Waterkloof, Pretoria',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Subdivision',
        description: 'Subdivision of Erf 298 Waterkloof into two (2) portions. Situated at 350 Milner Street, Waterkloof, Pretoria, 0181.',
        latitude: -25.7870,
        longitude: 28.2560,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '27',
        slug: 'remainder-erf-74-waterkloof',
        title: 'Subdivision: Remainder of Erf 74 Waterkloof',
        location: 'Waterkloof, Pretoria',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Subdivision',
        description: 'Subdivision of the Remainder of Erf 74 Waterkloof into two (2) portions. Situated at 372 Main Street, Waterkloof, Pretoria, 0145.',
        latitude: -25.7850,
        longitude: 28.2530,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '28',
        slug: 'erf-391-kempton-park-x2',
        title: 'Consent Use: Erf 391 Kempton Park Extension 2',
        location: 'Kempton Park, Ekurhuleni',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Consent Use',
        description: 'Special consent application to Ekurhuleni Metropolitan Municipality to use Erf 391 Kempton Park Extension 2 for the purpose of a "Place of Instruction" (College). Situated at 10 Miller Avenue, Kempton Park, 1619.',
        latitude: -26.1010,
        longitude: 28.2280,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '29',
        slug: 'erf-2512-stilbaai-wes',
        title: 'Consent Use: Erf 2512 Stilbaai Wes',
        location: 'Still Bay, Western Cape',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Consent Use',
        description: 'Consent application to Hessequa Local Municipality in respect of Erf 2512 Stilbaai West for the purposes of a Guest House (additionally to the dwelling house), with a second entrance to allow for access to parking bays directly from the adjacent street. Situated at 7 Buitekant Street, Still Bay West, 6674.',
        latitude: -34.3680,
        longitude: 21.4180,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '30',
        slug: 'erf-110-les-marais',
        title: 'Consent Use: Erf 110 Les Marais',
        location: 'Les Marais, Pretoria',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Consent Use',
        description: 'Consent application to the City of Tshwane Metropolitan Municipality to utilise Part B ("Residential 1") of Erf 110 Les Marais for the purpose of a parking site adjacent to use zone 6 (Part A: "Business 1" of the erf). Situated at 651 Paul Kruger Street, Les Marais, Pretoria, 0084.',
        latitude: -25.7080,
        longitude: 28.1870,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '31',
        slug: 'erf-2785-rooihuiskraal-extension-31',
        title: 'Consent Use: Erf 2785 Rooihuiskraal Extension 31',
        location: 'Rooihuiskraal, Centurion',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Consent Use',
        description: 'Consent application to the City of Tshwane Metropolitan Municipality to increase the current Coverage and Floor Area Ratio (FAR) of Erf 2785 Rooihuiskraal Extension 31. Situated at 33 Parkview Street, Rooihuiskraal, Centurion, 0154.',
        latitude: -25.8820,
        longitude: 28.1640,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '32',
        slug: 'remainder-erf-116-brooklyn',
        title: 'Consent Use: Remainder of Erf 116 Brooklyn',
        location: 'Brooklyn, Pretoria',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Consent Use',
        description: 'Consent application to the City of Tshwane Metropolitan Municipality to use the Remainder of Erf 116 Brooklyn as a Commune. Situated at 270 Hay Street, Brooklyn, Pretoria, 0011.',
        latitude: -25.7720,
        longitude: 28.2320,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '33',
        slug: 'portion-223-farm-doornkloof-centurion',
        title: 'Consent Use: Portion 223 of the Farm Doornkloof No. 391-JR',
        location: 'Irene Glen Estate, Centurion',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Consent Use',
        description: 'Consent application to the City of Tshwane Metropolitan Municipality for permission to establish an additional dwelling house on Portion 223 (a Portion of Portion 672) of the Farm Doornkloof No. 391-JR. Situated at 223 Hennops Drive, Irene Glen Estate, Centurion.',
        latitude: -25.8900,
        longitude: 28.2100,
        featured: false,
        completionDate: 'Completed',
      ...
      {
        id: '34',
        slug: 'portion-106-farm-elandsfontein-412-jr',
        title: 'Consent Use: Portion 106 of the Farm Elandsfontein 412 JR',
        location: 'Elandsfontein, Ekurhuleni',
        region: 'Southern Africa',
        country: 'South Africa',
        category: 'Consent Use',
        description: 'Special consent application to Ekurhuleni Metropolitan Municipality to operate an abattoir on Portion 106 of the Farm Elandsfontein 412 JR, zoned "Agricultural".',
        latitude: -26.2000,
        longitude: 28.3000,
        featured: false,
        completionDate: 'Completed',
